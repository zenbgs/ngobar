...
<div class="col-lg-6 mb-lg-0 mb-4">
    <div class="card card-body">
      ...
      <div class="choices" data-type="select-multiple" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false">
        <select class="form-control" id="choices-multiple-remove-button" data-color="dark" type="text" placeholder="Enter something" multiple hidden>
      ...
      <div class="d-flex justify-content-end mt-4">
        ...
        <button type="button" name="button" class="btn bg-gradient-primary m-0 ms-2">
          Create Project
        </button>
      </div>
    </div>
