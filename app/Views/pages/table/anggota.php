    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                ...
                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-icon btn-sm bg-gradient-success pull-right" style="float: right !important;" type="button">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="javascript:;" class="text-gradient btn-view text-success font-weight-bold text-xs" data-id="<?= $anggota->id ?>" data-first_name="<?= $anggota->first_name ?>" data-last_name="<?= $anggota->last_name ?>" data-email="<?= $anggota->email ?>" data-country="<?= $anggota->country ?>" data-toggle="tooltip" data-original-title="Lihat anggota">
                                            View
                                        </a>
                                        &nbsp;
